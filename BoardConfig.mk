...
BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD := \
    $(filter-out $(liuqin_incompatible_kernel_modules) $(device_second_stage_modules),$(BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD))
BOARD_VENDOR_KERNEL_MODULES_LOAD := \
    $(filter-out $(liuqin_incompatible_kernel_modules) $(device_second_stage_modules),$(BOARD_VENDOR_KERNEL_MODULES_LOAD))
BOOT_KERNEL_MODULES := \
    $(filter-out $(liuqin_incompatible_kernel_modules) $(device_second_stage_modules),$(BOOT_KERNEL_MODULES))
