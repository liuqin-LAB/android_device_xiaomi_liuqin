 ...
 * stock listener forwards the raw generation delta; the kernel decodes
 * generation 1 (shield) and generation 2 (counter) and clamps the generation
 * 3..7 connects to the generation-2 counter, so every supported pen opens the
 * shorthand gate.
 */
