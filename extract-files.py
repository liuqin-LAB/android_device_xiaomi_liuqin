...
if __name__ == '__main__':
    common = ExtractUtils.get_module('sm8450-common', module.vendor)
    # Cellular blobs are not installed on liuqin and cannot be extracted from it.
    phone_file_list = common.proprietary_file_path('proprietary-files-phone.txt')
    common.proprietary_files = [
        file for file in common.proprietary_files
        if file.file_list_path != phone_file_list
    ]
    utils = ExtractUtils(module, [common])
    utils.run()
